    ...
    return (
        <div className="relative h-full w-full">
            <div className="flex flex-col relative h-full w-full gap-5 items-center justify-center p-10 overflow-y-auto">
                ...
                <div className={`grid grid-cols-1 md:grid-cols-4 gap-2 p-5 relative border rounded-4xl items-center justify-center
                ...
                {injuredAdventurers.length > 0 && (
                    <button onClick={ () => handleHeal()} className="btn btn-success w-fit">
